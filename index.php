    ...
    <div id="carouselExample" class="carousel slide mt-4" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/hotel.jpg" class="d-block w-100" alt="G1"
                    style="aspect-ratio: 19 / 8; text-decoration: none;">
            </div>
            <div class="carousel-item">
                <img src="img/hotel1.jpg" class="d-block w-100" alt="G3"
                    style="aspect-ratio: 19 / 8; text-decoration: none;">
            </div>
            <div class="carousel-item">
                <img src="img/hotel2.jpg" class="d-block w-100" alt="G4"
                    style="aspect-ratio: 19 / 8; text-decoration: none;">
            </div>
            <div class="carousel-item">
                <img src="img/hotel3.jpg" class="d-block w-100" alt="G5"
                    style="aspect-ratio: 19 / 8; text-decoration: none;">
            </div>
            <div class="carousel-item">
                <img src="img/hotel4.jpg" class="d-block w-100" alt="G5"
                    style="aspect-ratio: 19 / 8; text-decoration: none;">
            </div>
        </div>
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-center mb-4">Tempat Beristirahat dengan Kenyamanan Berkelas, Pelayanan Ramah, dan
                    Fasilitas Berkualitas untuk Pengalaman Menginap yang Tak Terlupakan.</p>
